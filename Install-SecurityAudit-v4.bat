@echo off
setlocal
title SecurityAudit Portable Installer v4

echo ===============================================
echo SecurityAudit Portable Installer v4
echo ===============================================
echo.
...
set "SRC=%~dp0SecurityAudit-v4.ps1"
...
if not exist "%SRC%" (
    echo ERROR: SecurityAudit-v4.ps1 was not found beside this BAT file.
    echo.
    pause
    exit /b 1
)
...
findstr /B /C:"STATUS=OK" "%STATUSFILE%" >nul
if %errorlevel% neq 0 (
